                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('human-resource.profile') }}">My Profile</a>
                            <a class="dropdown-item" href="{{ route('human-resource.change.password') }}">Change Password</a>
                            <a class="dropdown-item" href="{{ route('human-resource.logout') }}">Logout</a>
                        </div>
                    </li>
                </ul>
