...
@section('title', 'Current Week Daily Report')
@section('sales')
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table id="examples" class="table table-striped custom-table display nowrap  table">
                        ...
                        <td>
                            <a href="{{ route('sales-reports.edit', $items->id) }}" class="btn btn-warning btn-rounded btn-sm text-white mb-1" title="Edit Data" > <i class="fa fa-eye"></i></a>
                        </td>
                            </tr>
                            @endforeach
                        </tbody>
