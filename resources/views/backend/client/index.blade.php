    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto float-end ms-auto">
                <a href="{{ route('clients.add') }}" class="btn add-btn"><i class="fa fa-plus"></i>Add @yield('title')</a>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table id="examples" class="table table-striped custom-table display nowrap  table">
                    ...
                    <tbody>
                        ...
                        <td class="text-end">
                                <a href="{{ route('clients.edit', $items->id) }}" class="btn btn-info btn-rounded btn-sm text-white mb-1" title="Edit Data" > <i class="fa fa-edit"></i></a>
                                <a href="{{ route('clients.delete', $items->id) }}"  class="btn btn-danger btn-rounded btn-sm mb-1"  id="delete" title="Delete Data" > <i class="fa fa-trash"></i></a>
                        </td>
                        </tr>
                        @endforeach
                    </tbody>
