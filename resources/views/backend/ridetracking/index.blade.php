            ...
            <table id="examples" class="table table-striped custom-table display nowrap  table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="btn btn-warning btn-rounded btn-sm" data-bs-toggle="modal" data-bs-target="#add_goal{{ $items->id }}"><i class="fa fa-eye"></i></a>
                            @if($items->status == '0')
                            <a href="{{ route('approve.ride',$items->id) }}" class="btn btn-success btn-rounded btn-sm text-white mb-1" title="Approve" id="ApproveBtn" > <i class="fa fa-thumbs-up"></i> </a>
                            <a href="{{ route('decline.ride',$items->id) }}" class="btn btn-danger btn-rounded btn-sm text-white mb-1" title="Decline" id="DeclineBtn"> <i class="fa fa-thumbs-down"></i> </a>
                            @else
                            @endif
                        </td>
                    </tr>
