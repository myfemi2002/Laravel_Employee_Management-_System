...
<head>
    ...
    <title>Error 403 :: {{ $allData->system_title }} </title>
    ...
    <body class="error-page">
        <div class="main-wrapper">
            <div class="error-box">
                ...
                <p>The Page you're trying to access has restricted access.<br>Try to refresh this page or contact your system adminstrator.</p>
